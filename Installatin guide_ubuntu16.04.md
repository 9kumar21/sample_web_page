...
### Jenkins as a service ubuntu:16.04
...
### Jenkins as a service ubuntu:18.04
...
apt-get update
apt-get install unzip software-properties-common wget openjdk-8-jdk
